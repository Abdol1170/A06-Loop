 ...
 */
let movements: [String] = ["socker", "football", "Swimming"]
...
var movementHeartRates: [String: Int] = ["socker": 99, "football": 80, "Swimming": 130]
for (movement, heartRate) in movementHeartRates {
    print("Movement: \(movement), heart rate: \(heartRate)")
}
